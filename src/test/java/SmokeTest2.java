...
public class SmokeTest2 {
    ...
    @Test
    public void calcSclValidationTest(){
        ...
        // 1. открыть браузер и перейти на тестируемую таблицу
...
//      sexDropDown.deselectByVisibleText("женский");

        // 3. Ввести Креатинин
        WebElement creatinin = driver.findElement(By.id("oCr"));
        creatinin.sendKeys(creatinineValue);
        ...
        Assert.assertEquals(actualMDRD, expectedMDRD, "MDRD различные");
        Assert.assertEquals(actualMDRD1, expectedMDRD1, "MDRD1 различные");
